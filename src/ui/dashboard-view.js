...
const FAVORITE_MODULES = {
  schedules: { label: "Horários", iconName: "calendar" }, lessons: { label: "Aulas", iconName: "book" }, chronogram: { label: "Cronograma", iconName: "file" }, tasks: { label: "Tarefas", iconName: "check" }, exams: { label: "Provas", iconName: "exam" }, presentations: { label: "Apresentações", iconName: "presentation" }, files: { label: "Arquivos", iconName: "folder" }, mindmaps: { label: "Mapas mentais", iconName: "mindMap" }, notes: { label: "Anotações", iconName: "note" }, summaries: { label: "Resumos", iconName: "note" }, flashcards: { label: "Flashcards", iconName: "flashcards" }, glossary: { label: "Glossário", iconName: "glossary" }, videos: { label: "Vídeos", iconName: "video" }, bibliography: { label: "Bibliografia", iconName: "book" }, disciplines: { label: "Disciplinas", iconName: "book" }, teachers: { label: "Professores", iconName: "users" }, profiles: { label: "Perfis de estudo", iconName: "graduation" },
};
