...
export function bindExamDetail(root, { onBack, onOpenTopics, onOpenMaterials, onOpenMindMaps, onOpenNotes, onOpenSummaries, onOpenVideos, onOpenBibliography }) {
  ...
  root.querySelector("[data-open-exam-notes]").addEventListener("click", onOpenNotes);
  root.querySelector("[data-open-exam-summaries]")?.addEventListener("click", onOpenSummaries);
  ...
  root.querySelector("[data-open-exam-bibliography]")?.addEventListener("click", onOpenBibliography);
}
