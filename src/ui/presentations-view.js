...
export function bindPresentationDetail(root, { presentation, contents, onBack, onEditInstructions, onEditLinks, onOpenMaterials, onOpenMindMaps, onOpenNotes, onOpenSummaries, onOpenVideos, onOpenBibliography, onOpenTasks, onOpenContent, onUpload }) {
  ...
  root.querySelector("[data-open-presentation-notes]").addEventListener("click", onOpenNotes);
  root.querySelector("[data-open-presentation-summaries]")?.addEventListener("click", onOpenSummaries);
  ...
  root.querySelector("[data-open-presentation-bibliography]")?.addEventListener("click", onOpenBibliography);
  root
