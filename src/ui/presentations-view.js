...
export function bindPresentationDetail(root, { presentation, contents, onBack, onEditInstructions, onEditLinks, onOpenMaterials, onOpenMindMaps, onOpenNotes, onOpenVideos, onOpenTasks, onOpenContent, onUpload }) {
